<?php
    ...
    while ($atlyginimas <= 2 * $_POST['atlyginimas']){
        $atlyginimas += $didinimas;
        $menesiai++;
    }
?>
...
<div class="wrapper">
    <div class="header">
        ...
        <div class="brd">
            ...
            <div class="result">
                <h3 id="text">Rezultatas:</h3> <span id="span"><?="Atlyginimas bus dvigubai didesnis po " . $menesiai . " mėnesių.";?></span>
            </div>
        </div>
    </div>
